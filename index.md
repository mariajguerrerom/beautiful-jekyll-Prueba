...
* Ajustar el ancho del contenedor de la página */
body {
  max-width: 1200px;
  margin: 0 auto;
}

/* Ajustar el tamaño máximo de las imágenes */
img {
  max-width: 100%;
  height: auto;
}

/* Ajustar el tamaño específico de la imagen principal en el index */
#main-image {
  width: 100%;
  max-width: 1200px;
  margin: 0 auto;
...
/* Ajustar el texto para que ocupe más espacio horizontal */
.text-container {
  max-width: 1000px;
  margin: 0 auto;
  text-align: justify;
...
<div style="font-family: Times; text-align: center;">
    <img id="main-image" src="images/front.png">
</div>
